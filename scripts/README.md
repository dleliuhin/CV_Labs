...
| Argument| Description                | Example                      |
|---------|----------------------------|------------------------------|
| -c      | Path to configuration file | ../cfg/zcm_img_viewer.cfg |
| -p      | Path to application PID    | /tmp/zcm_img_viewer       |
| others  | -                          | -                            |
...
- [rename.sh](rename.sh)
    ...
    Renames all lines with zcm_img_viewer in the whole project to the new project naming according to the script input argument.

*Example:* <br>

```./scripts/rename.sh zcm_img_viewer new_service preview``` - preview change files and lines.

```./scripts/rename.sh zcm_img_viewer new_service``` - recursively replace first argument to second in all files.

| Argument      | Description                        | Example            |
|---------------|------------------------------------|--------------------|
| №1            | The name to be replaced            | zcm_img_viewer  |
